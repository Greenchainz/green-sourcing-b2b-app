  ...
  return (
    <div className="flex h-screen bg-[#0a0a0a]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="h-16 bg-[#111111] border-b border-[#aaff00]/10 flex items-center justify-between px-8">
          <div className="flex items-center gap-4 flex-1">
             <div className="relative w-96">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-[#1a1a1a] border-none rounded-md focus:ring-2 focus:ring-green-500 outline-none text-sm"
                />
             </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden md:block">
                <div className="text-sm font-medium text-white">Acme Suppliers</div>
                <div className="text-xs text-slate-500">Verified Partner</div>
              </div>
              <div className="w-10 h-10 bg-[#1a1a1a] rounded-full flex items-center justify-center text-slate-400">
                <User size={20} />
              </div>
            </div>
          </div>
