    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <h1 className="text-5xl font-bold text-white mb-6">Supplier Agreement</h1>
                <p className="text-slate-400 mb-12">Last updated: January 2026</p>

                <div className="bg-[#111111] rounded-lg shadow-md p-8 space-y-6 text-slate-400">
                    <div>
                        <h2 className="text-2xl font-bold text-white mb-3">Agreement Overview</h2>
                        <p>This Supplier Agreement establishes the terms and conditions for suppliers using the GreenChainz platform.</p>
                    </div>

                    <div>
                        <h2 className="text-2xl font-bold text-white mb-3">Supplier Responsibilities</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-white mb-3">Data Privacy</h2>
