                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="gc-card p-8 space-y-8 text-slate-300">
                        ...
                        <section>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">2.1 Account Types</h3>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">2.2 Account Security</h3>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">2.3 LinkedIn Verification</h3>
                            <p>
                        ...
                        {/* RFQ System */}
                        <section>
                            <h2 className="text-2xl font-bold text-white mb-4">3. RFQ System and Deposits</h2>
                            
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">3.1 RFQ Deposit Requirement</h3>
                            <p className="mb-3">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">3.2 Refund Policy</h3>
                            ...
                            <div className="bg-emerald-50 p-4 rounded-lg space-y-3 mb-4">
                                <div>
                                    <p className="font-semibold text-white">✅ Full Refund (100%)</p>
                                ...
                                <div>
                                    <p className="font-semibold text-white">❌ No Refund</p>
                                    <ul className="list-disc pl-6 text-slate-300 mt-2 space-y-1">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">3.3 Payment Processing</h3>
                            <p>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-white mb-4">4. Verification Standards</h2>
                            
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">4.1 Supplier Certification Requirements</h3>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">4.2 Automated Verification</h3>
                            <p className="mb-3">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">4.3 False Certification Claims</h3>
                            <p className="mb-3">
                        ...
                        <section>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">6.1 User Content Ownership</h3>
                            <p className="mb-3">
                                You retain ownership of all content you upload to GreenChainz (product descriptions, images, documents, certifications).
                            </p>

                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">6.2 License to GreenChainz</h3>
                            <p className="mb-3">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">6.3 GreenChainz Platform IP</h3>
                            <p>
                        ...
                        <section>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">7.1 Marketplace Platform Role</h3>
                            <p className="mb-4">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">7.2 Maximum Liability Cap</h3>
                            <p className="mb-3">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">7.3 Disclaimer of Warranties</h3>
                            <p>
                        ...
                        <section>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">8.1 Informal Resolution</h3>
                            <p className="mb-3">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">8.2 Binding Arbitration</h3>
                            <p className="mb-3">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">8.3 Class Action Waiver</h3>
                            <p>
                        ...
                        <section>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">9.1 Termination by Users</h3>
                            <p>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">9.2 Termination by GreenChainz</h3>
                            <p className="mb-3">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">9.3 Data Deletion</h3>
                            <p>
                        ...
                        <section>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">11.2 Severability</h3>
                            <p>
                                If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions will continue in full force and effect.
                            </p>

                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">11.3 Entire Agreement</h3>
                            <p>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-3 mt-6">11.4 Assignment</h3>
                            <p>
                        ...
                        <section className="border-t border-[#aaff00]/10 pt-8">
                            ...
                            <div className="bg-emerald-50 p-6 rounded-lg">
                                <p className="font-semibold text-white mb-2">GreenChainz Legal Team</p>
