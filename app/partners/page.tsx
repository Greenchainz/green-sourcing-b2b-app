            ...
            <div className="gc-container py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
                    <div className="gc-card gc-card-hover p-8 text-center">
                        ...
                        <h3 className="text-xl font-bold text-white mb-3">Data Providers</h3>
                        <p className="text-slate-400 mb-4">Partner with us to provide certification and sustainability data. FSC, LEED, EPD, B Corp, and more.</p>
                    ...
                    <div className="gc-card gc-card-hover p-8 text-center">
                        ...
                        <p className="text-slate-400 mb-4">Integrate GreenChainz with ERP, BIM, project management, and procurement platforms.</p>
                    ...
                    <div className="gc-card gc-card-hover p-8 text-center">
                        ...
                        <h3 className="text-xl font-bold text-white mb-3">Reseller Program</h3>
                        <p className="text-slate-400 mb-4">Bring GreenChainz to your customers. Competitive margins and dedicated partner support.</p>
                ...
                <div className="gc-card max-w-3xl mx-auto p-8 text-center bg-gradient-to-br from-emerald-50 to-teal-50">
                    ...
                    <p className="text-slate-400 mb-6">Let's discuss how we can work together to advance sustainable commerce.</p>
