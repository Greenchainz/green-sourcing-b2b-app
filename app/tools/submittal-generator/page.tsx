...
export default function SubmittalGeneratorPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a]">
            {/* Header */}
            <section className="bg-[#111111] border-b border-[#aaff00]/10 py-12 px-6">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    {(stage === "upload" || stage === "processing") && (
                        <div
                            ...
                            className="border-2 border-dashed border-[#aaff00]/15 rounded-2xl p-12 bg-[#111111] text-center hover:border-green-500 transition-all hover:shadow-lg"
                        >
                    ...
                    {stage === "complete" && downloadUrl && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-[#111111] border border-[#aaff00]/10 rounded-lg p-8 space-y-4">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    onClick={resetForm}
                                    className="px-6 py-4 border border-[#aaff00]/15 text-slate-300 hover:bg-[#1a1a1a] rounded-lg font-semibold transition"
                                >
                                    Generate Another
                                </button>
                            </div>

                            <div className="bg-[#0a0a0a] border border-[#aaff00]/10 rounded-lg p-4 text-sm text-slate-400">
                    ...
                    <div className="mt-12 grid md:grid-cols-3 gap-6">
                        <div className="bg-[#111111] p-6 rounded-lg border border-[#aaff00]/10">
                            <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
                                <span className="text-xl font-bold text-blue-600">1</span>
                            </div>
                            <h4 className="font-bold text-white mb-2">Upload Spec</h4>
                        ...
                        <div className="bg-[#111111] p-6 rounded-lg border border-[#aaff00]/10">
                            ...
                            <h4 className="font-bold text-white mb-2">AI Extracts</h4>
                            <p className="text-sm text-slate-400">
                        ...
                        <div className="bg-[#111111] p-6 rounded-lg border border-[#aaff00]/10">
                            ...
                            <h4 className="font-bold text-white mb-2">We Package It</h4>
                            <p className="text-sm text-slate-400">
