      ...
      <section className="hero-premium relative overflow-hidden text-white py-28 md:py-40 px-6 text-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="mt-14 flex flex-wrap justify-center gap-6 md:gap-10 text-white/80 text-sm animate-fade-in-up" style={{
            ...
            <span className="flex items-center gap-2 bg-[#111111]/10 backdrop-blur-sm px-4 py-2 rounded-full">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="feature-card-premium group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Cut Compliance Costs</h3>
            ...
            <div className="feature-card-premium group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Save Hours Every Week</h3>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="feature-card-premium group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Stay Ahead of Regulations</h3>
              <p className="text-slate-400 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card-rainbow-border group hover:scale-[1.02] transition-all duration-500">
              ...
              <h3 className="text-2xl font-black mb-3 text-white group-hover:text-[#aaff00] transition-colors">Excel Audit</h3>
            ...
            <div className="card-rainbow-border group hover:scale-[1.02] transition-all duration-500">
              ...
              <h3 className="text-2xl font-black mb-3 text-white group-hover:text-[#aaff00] transition-colors">Browser Extension</h3>
              <p className="text-slate-400 mb-6 text-base leading-relaxed">
            ...
            <div className="card-rainbow-border group hover:scale-[1.02] transition-all duration-500">
              ...
              <h3 className="text-2xl font-black mb-3 text-white group-hover:text-[#aaff00] transition-colors">Revit Plugin</h3>
              <p className="text-slate-400 mb-6 text-base leading-relaxed">
            ...
            <div className="card-rainbow-border group hover:scale-[1.02] transition-all duration-500">
              ...
              <h3 className="text-2xl font-black mb-3 text-white group-hover:text-[#aaff00] transition-colors">Submittal Generator</h3>
              <p className="text-slate-400 mb-6 text-base leading-relaxed">
