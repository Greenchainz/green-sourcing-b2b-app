        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Hover over any product on a supplier website. Instantly see carbon scores, certifications, and red flags—without leaving the page.
            </p>
      ...
      <section id="demo" className="py-20 bg-secondary/30">
        <div className="container">
          <div className="max-w-5xl mx-auto">
            <VideoPlaceholder
              title="See the Extension in Action"
              description="Watch how we surface sustainability data on any supplier website"
              aspectRatio="16/9"
            />
          </div>
        </div>
        ...
        <div className="container relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Stop Greenwashing in Its Tracks
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Real-time verification overlays on every product page you visit.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Hover over any material name. We check it against 50K+ EPDs in milliseconds.',
                color: 'from-[oklch(0.85_0.15_145)] to-[oklch(0.75_0.12_145)]'
              },
              {
                icon: '🚨',
                title: 'Greenwash Alerts',
                description: 'Red flags for vague claims like "eco-friendly" without third-party proof.',
                color: 'from-[oklch(0.75_0.12_145)] to-[oklch(0.65_0.14_145)]'
              },
              {
                icon: '📊',
                title: 'Side-by-Side Compare',
                description: 'View carbon scores and certifications for competing products on the same page.',
                color: 'from-[oklch(0.65_0.14_145)] to-[oklch(0.55_0.16_145)]'
              },
              {
                icon: '💾',
                title: 'Save to Project',
                description: 'One-click bookmarking to your GreenChainz material library.',
                color: 'from-[oklch(0.80_0.20_145)] to-[oklch(0.70_0.12_145)]'
              },
              {
                icon: '🔗',
                title: 'Works Everywhere',
                description: 'Compatible with major supplier sites: Unilock, CertainTeed, Kingspan, etc.',
                color: 'from-[oklch(0.75_0.12_145)] to-[oklch(0.65_0.14_145)]'
              },
              {
                icon: '⚡',
                title: 'Zero Friction',
                description: 'No copy-paste, no tab-switching. Data appears exactly where you need it.',
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-12">
              Three Steps to Smarter Sourcing
            </h2>
              ...
              {[
                {
                  ...
                  description: 'One-click install from the Chrome Web Store. No account required to start.',
                  color: 'oklch(0.85_0.15_145)'
                },
                {
                  step: '02',
                  title: 'Browse Supplier Sites',
                  description: 'Visit any product page. Our AI detects material names and pulls sustainability data.',
                  color: 'oklch(0.75_0.12_145)'
                },
                {
                  step: '03',
                  title: 'See the Truth',
                  description: 'A floating card appears with carbon scores, certifications, and compliance status.',
            ...
            <Card className="p-8 md:p-12 bg-card/80 backdrop-blur-lg border-border/50 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-muted-foreground">
                  Be among the first to get the Browser Extension when we launch. No credit card required.
                </p>
              </div>

              <LeadCaptureForm toolName="Browser Extension" />
